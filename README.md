...
## 🚀 Featured Project: Arduino Parktronic System
Check out my latest work on an ultrasonic parking assistant. It features real-time distance tracking, visual RGB feedback, and acoustic alerts.

*   **Repository:** [Arduino-project/L7-Intex-Parktronic](https://github.com/Bogdana-Kira/Arduino-project/tree/main/L7-Intex-Parktronic)
*   **Video Demo:** [Watch on YouTube](https://youtu.be/hYuQe4qngJM)

---

## 🛠 Tech Stack & Tools
*   **Programming:** C++, Arduino Language
*   **Hardware Simulation:** Tinkercad, Wokwi, Circuito
*   **Version Control:** GitHub
*   **Engineering Focus:** Embedded Systems, IoT, Sensor Logic
